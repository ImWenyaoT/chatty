...
test("executeSearchRequest executes a model-selected query and returns trace evidence", async () => {
...
test("executeSearchRequest deduplicates the normalized model query", async () => {
  const searcher = knowledgeSearcher([
    {
      text: "SUIT-001 身高 175-181 体重 66-80 建议 L",
      section: "SUIT-001 尺码参考",
