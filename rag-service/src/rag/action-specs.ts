...
export const ACTION_SPECS: Partial<Record<ActionKind, ActionSpec>> = {
  ...
  repair: {
    goal: '用户说"没听懂/？/再说一遍"，把上一轮你想问的事用更简单一句话再说一遍。',
    hardRules: [
      '不要长篇道歉',
      '如果 hint 有内容，用自然口语复述一次',
      '不要解释自己是 AI 或系统',
    ],
    maxSentences: 2,
    maxChars: 60,
    goodExamples: [
      '哦这边的意思是，您哪天用衣服发我一下就行',
      '没说清楚，我是想问您身高体重，这样帮您选尺码',
    ],
    badExamples: [
  ...
  confirm_review: {
    ...
    maxChars: 120,
    goodExamples: [
      '我再跟您对一下：SUIT-001 黑色西装，5-9 到 5-10 用，尺码按 L 码。您看这几项都对吧？',
    ],
    badExamples: [
  ...
  quote_price: {
    ...
    maxChars: 100,
    goodExamples: [
      '这款首日 199、续租一天 99.5，寄出包邮，在途不算租期',
      '按天租，首日 199 续租半价，您把日期发我顺便帮您看档期',
    ],
  },

  rental_howto: {
    goal: '简短解释租赁规则（按天租、续租半价、在途不算、寄出包邮）。',
    hardRules: [
      '最多 4 句',
    ...
    maxChars: 180,
    goodExamples: [
      '我们按天租的，首日全价续租半价，在途不算租期，寄出包邮。您把想租的款式发我我帮您看看',
    ],
  },
